...
// remove div containter
$("#oc-images").find(".mod_newslist").contents().unwrap();

// verscheibe gallerie
$("#sport_news_galery").insertAfter("#content .content-wrap");

// verscheibe abseitz vorstand
$("#abseitz-vorstand").insertAfter("#content .content-wrap");

// verscheibe maps
$("#google-maps-container").insertAfter("#content .content-wrap");

$("#abseitz_link, #sportarten_link").click(function(e) {
	return false;
});
...
$("#google-maps-button").click(function(e) {
	...
	if ($("#google-map").css("margin-bottom") == "0px") {
		$("#google-map").animate({
			"margin-bottom": "-500px"
		  }, 300, function() {
			// Animation complete.
			$("#google-map, #news-section-sportarten").css({"box-shadow":"0 0 10px rgba(0, 0, 0, 0.1)"});
		  });
		...
		$("#google-map").animate({
		  ...
		  $("#google-map, #news-section-sportarten").css({"box-shadow":"0 0 10px rgba(0, 0, 0, 0.4)"});
		  
		  $(this).text("Karte schließen");
...
// Keine Aktivitäten
if($("#news-section-sportarten p").hasClass("empty")) {
	//$("#news-section-sportarten .container").css({"display":"none"});
}
...
(function($){
	...
	SEMICOLON.initialize = {
		...
		init: function(){
			...
			// position footer abseitz icon
			var footerAbseitzIcon = ($("#copyrights .container").outerWidth() - 80) / 2;
			$("#footer_abseitz_icon").css({"left":footerAbseitzIcon+"px"});
			
			// position abseitz sport icon
			var sportIcon = ($("#content").outerWidth() - $("#page-title .container ").outerWidth()) / 2 + 10;
			$("#content .icon_sport_content").css({"right":sportIcon+"px"});
		...
		fullWidthMenu: function(){
			...
			if( $body.hasClass('stretched') ) {
				...
				if( $header.hasClass('full-header') ) { 
					var widthMegaMenu = ($wrapper.width() / 2 )- 60 ;
					var leftMegaMenu = $wrapper.width() / 2 ;

					if ($(window).width() > 991) {
						$('.mega-menu .mega-menu-content').css({ 'width': widthMegaMenu, 'left': leftMegaMenu});
					} else {
						$('.mega-menu .mega-menu-content').css({ 'width': $wrapper.width()- 60, 'left': 0});
					}					
				...
				if( $header.hasClass('full-header') ) { 
					var widthMegaMenu = ($wrapper.width() / 2 )- 80 ;
					var leftMegaMenu = $wrapper.width() / 2 ;

					if ($(window).width() > 991) {
						$('.mega-menu .mega-menu-content').css({ 'width': widthMegaMenu, 'left': leftMegaMenu});
					} else {
						$('.mega-menu .mega-menu-content').css({ 'width': $wrapper.width()- 80, 'left': 0});
					}
				}
			}
		},
